...
${OBJECTDIR}/_ext/896ecef2/KMeans.o: ../KMeans/KMeans.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/896ecef2/KMeans.o ../KMeans/KMeans.cpp

${OBJECTDIR}/_ext/896ecef2/Point.o: ../KMeans/Point.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/896ecef2
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/896ecef2/Point.o ../KMeans/Point.cpp
