...
# Object Files
OBJECTFILES= \
	${OBJECTDIR}/_ext/1989226766/KMeans.o \
	${OBJECTDIR}/_ext/1989226766/Point.o \
	${OBJECTDIR}/main.o
...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/kmeans: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/kmeans ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/_ext/1989226766/KMeans.o: ../KMeans/KMeans.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1989226766
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1989226766/KMeans.o ../KMeans/KMeans.cpp

${OBJECTDIR}/_ext/1989226766/Point.o: ../KMeans/Point.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1989226766
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1989226766/Point.o ../KMeans/Point.cpp
